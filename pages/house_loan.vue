<template>
    <div class="house_loan">
        <nya-container title="屏幕录制">
            ...
            <nya-checkbox v-model="choosePrepayment" class="mt-15" label="提前还款" />
            <div v-if="choosePrepayment">
                <client-only>
                    <date-picker v-model="firstRepaymentDate" class="nya-input" :editable="false" placeholder="第一次还款时间" :default-value="firstRepaymentDate" value-type="format" :not-before="from" :not-after="to" />
                    <date-picker v-model="intendedRepaymentDate" class="nya-input" :editable="false" placeholder="预计提前还款时间" :default-value="intendedRepaymentDate" value-type="format" :not-before="from" :not-after="to" />
